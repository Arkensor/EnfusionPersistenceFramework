[BaseContainerProps()]
class EPF_ComponentSaveDataClass
{
...
class EPF_ComponentSaveData
{
	...
	bool IsFor(IEntity owner, GenericComponent component, EPF_ComponentSaveDataClass attributes)
	{
		return true;
	}
...
class EPF_ComponentSaveDataType : BaseContainerCustomTitle
{
	...
	//------------------------------------------------------------------------------------------------
	void EPF_ComponentSaveDataType(typename componentType)
	{
